...
if(mouse_dir<45 || mouse_dir>315) sprite_index = spr_player_walk_r;
else if(mouse_dir<135 && mouse_dir>45) sprite_index = spr_player_walk_u;
else if(mouse_dir<225 && mouse_dir>135) sprite_index = spr_player_walk_l;
else if(mouse_dir<315 && mouse_dir>225) sprite_index = spr_player_walk_d;
